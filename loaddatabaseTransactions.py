...
config = {
    'host': 'kroger-data-server.mysql.database.azure.com',
    'user': 'satvikasura',
    'password':'CloudFinalProject1234',
    'database':'kroger-retail'
    }
try:
...
df = pd.read_csv("/Users/satvikasura/Downloads/8451_The_Complete_Journey_2_Sample-1/400_transactions.csv")
